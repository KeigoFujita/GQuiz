 ...
 @section('content')
     <div class="container-fluid p-5 main-content">
         ...
         @if (Auth::user()->role == 'employee' && Auth::user()->employee->is_teacher == false)
             <nav aria-label="breadcrumb" style="background-color:transparent;">
                 <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="{{ route('sections.index') }}" class="text-info">Sections</a>
                     </li>
                     <li class="breadcrumb-item"><a href="{{ route('sections.show', $section) }}"
                             class="text-info">{{ $section->section_name }}</a></li>
                     <li class="breadcrumb-item active" aria-current="page">Clearances</li>
                         ...
                         <tr>
                             ...
                             <td>
                                 ...
                                 <div class="form-group my-0">
                                    ...
                                    @if ($student->adviser_clearance->status == 'complete') bg-success
                                     @else
                                         bg-danger @endif


                                         " clearance_id="{{ $student->adviser_clearance->id }}">
                                         <option value="complete" @if ($student->adviser_clearance->status == 'complete') selected @endif>Complete</option>
                                         <option value="incomplete" @if ($student->adviser_clearance->status == 'incomplete') selected @endif>Incomplete</option>
                                     </select>
                                 </div>
