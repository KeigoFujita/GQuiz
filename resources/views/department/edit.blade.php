...
@section('content')
<div class="container-fluid p-5 pt-3 main-content">
    ...
    <div class="row ">
        ...
        <div class="col-md-12">
            ...
            <p class="adviser">{{$department->role->assigned_officer->full_name}}</p>
        ...
        <div class="col-md-12" style="padding-bottom:400px;">
            ...
            {{-- <h1 class="mb-5 mt-2 display-4 title" style="font-size: 2rem;">Requirements</h1> --}}
                        ...
                        <td>
                            ...
                            <div class="dropdown show" style="display:inline-block">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    ...
                                    Clearance</a> --}}
                                    <a class="dropdown-item text-success" href="{{ route('departments.clearances',$requirement) }}">Manage Clearance</a>
