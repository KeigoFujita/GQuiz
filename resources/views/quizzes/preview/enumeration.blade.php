        ...
        <div class="container rounded px-4 py-3 pb-5  position-relative"
            ...
            <div class="px-0 py-4 position-relative bg-white shadow-sm rounded question-box" style="top: 2rem;" >
                ...
                <div class="px-4 py-4">
                    ...
                    <textarea type="text" rows="3" class="form-control" placeholder="Enter your answer here..." required></textarea>
                </div>
                @endforeach
                <button class="mx-4 btn text-white" style="background-color: {{ $color }}">Submit Answer</button>
            </div>
