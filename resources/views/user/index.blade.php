            ...
            <tr>
                ...
                <td>
                    @if (isset($student->user))
                        ...
                        <span class="badge badge-success section-name" data-toggle="tooltip" data-placement="top"
                            title="
                                                                                        {{-- {{ $student->user->created_at }} --}}
                                                                                        Verified at {{ \Carbon\Carbon::parse($student->user->created_at)->format('m/d/Y') }}">Account
                            Verified</span>
                    @else
                        <button class='btn btn-outline-danger btn-sm' data-toggle="modal" data-target="#setupAccount"
                            data-student_id="{{ $student->id }}" onclick="settype('student')">Setup
                            Account</button>
                    @endif
                </td>
            </tr>
