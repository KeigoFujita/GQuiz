...
<div class="container-fluid p-5 main-content">
    ...
    <div class="row ">
        ...
        <div class="col-md-12">
            ...
            <h1 class="display-4 title mb-5">Add Employee</h1>
            ...
            <form action="{{ route('employees.store')}}" method="post" id="form_main">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <select name="roles[]" id="roles"
                                class="form-control tag-selector @error('roles') is-invalid @enderror" multiple
                                form="form_main" data-width="100%">

                                @foreach ($roles as $role)
                                <option value="{{ $role->id}}" @if(collect(old('roles'))->contains($role->id))selected
                ...
                <button type="submit" class="btn btn-success mt-3 btn-sm" name="submit">Add Employee</button>
            </form>
        </div>
    </div>
</div>
