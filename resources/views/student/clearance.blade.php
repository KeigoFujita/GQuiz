    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('students.clearance.print',$student) }}" onclick="" class="btn btn-outline-main mr-1">Print</a>
                <a href="{{ route('students.clearance.pdf',$student) }}" class="btn btn-main">Save as PDF</a>
            </div>
        </div>
    </div>
    <div class="container border px-5 mt-5 pb-5" style="font-family: Arial, Helvetica, sans-serif;">
        ...
        <div class="mt-4">
            ...
            <table class="table-space-half simple-table-border w-100">
                ...
                <tbody>
                    @foreach ($subject_clearances as $subject_clearance)
                    <tr>
            ...
            <table class="table-space-half simple-table-border w-100">
                ...
                <tbody>
                    <tr>
                         ...
                         <td class="text-center">
                            <span class="badge badge-{{ $adviser_clearance->status == 'complete' ? 'success' : 'danger'  }}">
                                {{ $adviser_clearance->status == 'complete' ? 'Complete' : 'Incomplete'  }}
                            </span>
                          </td>
                         <td class="text-center">{{ $adviser_clearance->status == 'complete' ? $adviser_clearance->updated_at->format('m-d-Y') : 'N/A' }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
