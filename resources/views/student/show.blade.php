            ...
            <div class="container-fluid mt-5">
                @if (Auth::user()->role == 'employee')
                    <div class="row justify-content-end">
                        <a href="{{ route('students.clearance',$student) }}" class="btn btn-outline-success btn-sm mr-1">
                            Print Clearance
                        </a>
        ...
        <div class="col-12">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="classes" role="tabpanel" aria-labelledby="classes-tab">
                    ...
                    @if ($student->section->school_classes->count() == 0)
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-centered   table-hover shadow-sm custom-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td scope="row" data-label="Subject">{{ $class->subject->subject_name }}</td>
                ...
                <div class="tab-pane fade" id="clearance" role="tabpanel" aria-labelledby="clearance-tab">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-centered table-hover shadow-sm  custom-table">
                            ...
                            <tbody>
                                ...
                                @foreach ($class_clearances as $clearance)
                                <tr>
                                    <td scope="row" data-label="Subject">
                                        {{ $clearance->class_requirement->school_class->subject->subject_name }}</td>
                                    <td data-label="Lecturer">
                                        {{ $clearance->class_requirement->school_class->employee->full_name }}</td>
                                    <td data-label="Requirement">{{ $clearance->class_requirement->requirement }}</td>
                                    <td data-label="Details">
                                        {{ $clearance->class_requirement->requirement_description }}</td>
                                    <td data-label="Deadline">{{ $clearance->class_requirement->deadline }}</td>
                                    <td data-label="Status">

                                        @if ($clearance->status == 'complete')

                                        <h1 class="badge badge-success">
                                            {{ $clearance->status == 'complete' ? 'Completed' : "" }}
                                        </h1>

                                        @else
                                        <h1 class="badge badge-danger">
                                            {{ $clearance->status == 'incomplete' ? 'Incomplete' : "" }}
                                        </h1>
                                        @endif
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-centered table-hover shadow-sm custom-table">
                            ...
                            <tbody>
                                <tr>
                                    <td scope="row" data-label="Section">{{ $student->section->section_name }}</td>
                                    <td data-label="Adviser">{{ $student->section->employee->full_name }}</td>
                                    <td data-label="Status">

                                        @if ($student->adviser_clearance->status == 'complete')

                                        <h1 class="badge badge-success">
                                            {{ $student->adviser_clearance->status == 'complete' ? 'Completed' : "" }}
                                        </h1>

                                        @else
                                        <h1 class="badge badge-danger">
                                            {{ $student->adviser_clearance->status == 'incomplete' ? 'Incomplete' : "" }}
                                        </h1>
                                        @endif
                    ...
                    @if ($department_clearances->count() == 0)
                    <div class="container-fluid px-0">
                    ...
                    <div class="table-resposive">
                        <table class="table table-bordered table-centered table-hover shadow-sm custom-table">
                            ...
                            <tbody>
                                ...
                                @foreach ($department_clearances as $department_clearance)

                                <tr>
                                    <td data-label="Department">{{ $department_clearance->department->department_name }}
                                    </td>
                                    <td data-label="Officer">
                                        {{ $department_clearance->department->role->assigned_officer['full_name'] }}
                                        <span class="badge badge-info ml-2">
                                            {{ ucfirst($department_clearance->department->role->role_name) }}
                                        </span>
                                    </td>
                                    <td data-label="Requirement">
                                        {{ $department_clearance->department_requirement->requirement }}</td>
                                    <td data-label="Details">
                                        {{ $department_clearance->department_requirement->requirement_description }}
                                    </td>
                                    <td data-label="Deadline">
                                        {{ $department_clearance->department_requirement->deadline }}</td>
                                    <td data-label="Status">

                                        @if ($department_clearance->status == 'complete')

                                        <h1 class="badge badge-success">
                                            {{ $department_clearance->display_status() }}
                                        </h1>
                    ...
                    <table class="table table-bordered table-centered   table-hover shadow-sm custom-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="Details">{{ $student->grade_level == '11' ? "Grade 11" : "Grade 12"}}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td data-label="Details">{{ $student->section->section_name}}</td>
                            </tr>

                            <tr>
                                <td data-label="Name">Adviser</td>
                                <td data-label="Details">{{ $student->section->employee->full_name}}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td data-label="Details">{{ $student->section->school_classes->count()}}</td>
                            </tr>
