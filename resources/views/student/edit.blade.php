                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="grade_level" id="grade_level"
                                    ...
                                    <option value="1" @if (old('grade_level') !== null)  @if (old('grade_level')==1)
                                        selected @endif
                                    @else
                                    ...
                                    <option value="2" @if (old('grade_level') !== null)  @if (old('grade_level')==2)
                                        selected @endif
                                    @else
                                    ...
                                    <option value="3" @if (old('grade_level') !== null)  @if (old('grade_level')==3)
                                        selected @endif
                                    @else
                            ...
                            <div class="form-group">
                                ...
                                <select id="strand_id"
                                    ...
                                    @foreach ($strands as $strand)
                                        <option value="{{ $strand->id }}" @if (old('strand') !== null)  @if (old('strand')==$strand->id)
                                            selected @endif
                                        @else
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                    name="first_name" value="@if ($errors->has('first_name')) {{ old('first_name') }}@else{{ $student->first_name }} @endif">
                                @error('first_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('middle_name') is-invalid @enderror"
                                    name="middle_name" value="@if ($errors->has('middle_name')) {{ old('middle_name') }}@else{{ $student->middle_name }} @endif">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('last_name') is-invalid @enderror"
                                    name="last_name" value="@if ($errors->has('last_name')) {{ old('last_name') }}@else{{ $student->last_name }} @endif">
