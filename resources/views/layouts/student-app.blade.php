...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md shadow-sm" style="height: 5rem !important;">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="navbar-nav ml-3" style="font-size: 1.1rem;">
                        <a class="nav-item nav-link" href="{{ route('students.show', Auth::user()->student) }}">Classes</a>
