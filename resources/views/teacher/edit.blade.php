                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                    name="first_name" value="@if ($errors->has('first_name')) {{ old('first_name') }}@else{{ $employee->first_name }} @endif">
                                @error('first_name')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('middle_name') is-invalid @enderror"
                                    name="middle_name" value="@if ($errors->has('middle_name')) {{ old('middle_name') }}@else{{ $employee->middle_name }} @endif">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('last_name') is-invalid @enderror"
                                    name="last_name" value="@if ($errors->has('last_name')) {{ old('last_name') }}@else{{ $employee->last_name }} @endif">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input type="text" class="form-control  @error('mobile_number') is-invalid @enderror"
                                        name="mobile_number" value="@if ($errors->has('mobile_number')) {{ old('mobile_number') }}@else{{ $employee->mobile_number }} @endif">
                                    @error('mobile_number')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                ...
                                <select name="roles[]" id="roles" class="form-control tag-selector" form="form_main"
                                    ...
                                    @foreach ($roles as $role)
                                        <option value="{{ $role->id }}" @if ($employee->hasRole($role->id)) selected @endif>{{ $role->role_name }}</option>
                                    @endforeach
